...
namespace BeastStrap.Extensions
{
    static class RobloxIconEx
    {
        ...
        // BeastStrap's own icon, used as the visual stand-in for the default / placeholder
        // choices in the picker (a "keep Roblox's icon" option has no icon of its own to show).
        private static Icon GetBrandIcon() => BootstrapperIconEx.GetBrandIcon();
    }
}